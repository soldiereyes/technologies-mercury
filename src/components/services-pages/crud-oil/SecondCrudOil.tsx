...
import './SecondCrudOil.css';

const CrudeOilSection2: React.FC = () => {
    return (
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-md-5 position-relative">
                        <div className="image-wrapper">
                            <img src="/public/images/crude-oil-along-beach-ao-phrao-after-nearby-oil-spill-gulf-thailand.jpg" alt="Crude Oil in Hands" className="img-fluid rounded crude-image" />
...
export default CrudeOilSection2;
