...
import './UreaSection.css';

const UreaSection: React.FC = () => {
    return (
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-md-5 position-relative">
                        <div className="image-wrapper">
                            <img src="/public/images/urea-fertilizer.jpg" alt="Crude Oil in Hands" className="img-fluid rounded crude-image" />
